...
{\footnotesize \[\begin{aligned}&\left(0\right)A(x)+\left(4\,x^{2} - 32\,x + 64\right)A'(x)\\[-1pt]&+\left(14\,x^{3} - 168\,x^{2} + 672\,x - 1139\right)A^{(2)}(x)+\left(4\,x^{4} - 64\,x^{3} + 384\,x^{2} - 781\,x + 52\right)A^{(3)}(x)=0.\end{aligned}\]}
