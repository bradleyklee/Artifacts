from sympy import symbols, diff, simplify, factor, together, expand, Rational, Poly, fraction, nsimplify
...
print("Numerator of (LHS - RHS) after combining fractions, symbolic in n and u:")
print(num_expanded)
print()
print("Is numerator identically zero (as polynomial in n,u)?", num_expanded == 0)
